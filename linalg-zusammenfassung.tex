...
\begin{abstract}
	%enterlater
	\centerline{\bt{Stand zum zweiten Semester}}
\end{abstract}
...
\begin{remark}
\bt{Rechenverfahren zur Bestimmung der Basiswechselmatrix einer Jordan-Normalform}
\begin{enumerate}
...
\begin{definition}
Das \bt{kanonische Skalarprodukt im $\mathbb{C^n}$} ist die Abbildung $$\langle\quad, \quad\rangle: \mathbb{C}^{n} \times \mathbb{C}^{n} \rightarrow \mathbb{R}, \quad(x, y) \mapsto\langle x, y\rangle  = \overline{y}^T \cdot x.$$
