...
\begin{corollary}
F"ur jede lineare Abbildung $F : V \rightarrow W$ gilt $F^{**} = F$, sovern man $V$ und $V^{**}$ und $W$ und $W^{**}$ mittels $\iota$ identifiziert.
\end{corollary}
...
$$
Eine Bilinearform $b$ heisst \bt{nicht ausgeartet}m falls $b'$ und $b''$ injektiv sind.
\end{definition}
